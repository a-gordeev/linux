 ...
 * @hwirq_base: beginning of hardware IRQ range in that domain space
 * @count: number of interrupts to map
 *
 * Only one mapping per hardware interrupt is permitted. Returns a linux irq
 * base number for a contiguous range of hardware irqs mapped to linux irq
 * space.
...
/**
 * irq_dispose_mappings() - Unmap an interrupt
 * @virq_base: base number of linux IRQ range to unmap
